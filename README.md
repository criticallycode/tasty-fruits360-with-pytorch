# tasty-fruiits360-with-pytorch
An image classifier designed with PyTorch, operates on the Fruits-360 dataset.

This repo demonstrates how to create an image classification model with PyTorch. The dataset used for this repo is the Fruits-360 dataset, available [HERE.](https://www.kaggle.com/moltean/fruits)  This repo contains a Jupyter Notebook that allows you to run the cells and experiment with the model. It also acts a tutorial for the process of creating and training an image classification model with PyTorch, explaining the various code blocks.
...
After this, the model is created and instantiated with various required arguments.
...
Finally, the training is carried out:
